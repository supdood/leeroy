class OgreRoom
  ...
  def get_action
    ...
    if choice.include?("search") && !@sword
      ...
      puts "You see the faint outline of a door behind the large mound.\n"
      ...
      puts "The mound awakes and you realize it is a terrifying ogre, but you're prepared.\n"
      ...
      puts "The nasty beast has been slain! Your path to a now visible door is clear.\n\n"
      @ogre = true
    elsif choice.include?("door") && !@mound 
      puts "Something is blocking your way!\n\n"
    elsif choice.include?("door") && @ogre
      puts ""
      puts "You step into the next room...\n\n"
      @keep_going = false
    elsif choice.include?("door") && @undetected
      puts "You slowly make your way by the slumbering ogre."
      puts "Your path to a visible door is now clear."
      puts "You step into the next room...\n\n"
      @keep_going = false
